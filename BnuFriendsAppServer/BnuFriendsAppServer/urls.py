...
urlpatterns = patterns('',
    ...
    (r'^appserver/admin/user/', include('BnuFriendsAppServer.src.backend_urls.user_urls')),
    (r'^appserver/admin/news/', include('BnuFriendsAppServer.src.backend_urls.news_urls')),
